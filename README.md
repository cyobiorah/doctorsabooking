...
A small server-rendered doctor marketplace: a patient requests care, doctors bid, the patient chooses a doctor, and an authenticated mock payment webhook assigns the visit.
...
1. Sign in as the patient and request a future visit. Time entry and display are explicitly UTC.
2. In another browser profile/private window, sign in as a doctor and submit a price and note. Optionally bid as the second doctor.
